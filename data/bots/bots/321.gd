...
@export var game_url: String = "https://play2helpgamesserver.onrender.com/racingGame/?to=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjoxNzM2MDYxMzMwLCJpYXQiOjE3MzU5NzQ5MzAsImp0aSI6IjZmYzlmZDk3MzY0OTQzM2JiOTAwOGM0YWU5MzQxOTUyIiwidXNlcl9pZCI6MTF9.ymAgeQl2e7FxUfe5LWJx8pNvBPvhhnOj_3Qq5T6yTfw"
...
func open_game_window() -> void:
	...
	if OS.has_feature("webview"):
		var web_view: WebView = WebView.new()
...
func add_highlight() -> void:
	chest_meshinstance.set_surface_override_material(0, chest_material.duplicate() as Material)
